...
Through its hsv representation, the color intensity can be clamped to a chosen level using the following formula. 
...
\medskip \par
\noindent
Normal smoothing consists of average every vertex normal with the normals of its neighbors.
