...
\begin{figure}[h]
	...
	\subfloat[Wobbling with morphological smoothing.]{\includegraphics[width=0.47\columnwidth]{imgs/wob_on_smooth.png}\label{fig:wobbling_results2}}
	\hspace{1em}
...
Figure \ref{fig:result} shows the resulting image after all mentionned effects have been applied to the scene.
\begin{figure}[h]
	\centering
...
\noindent
Larger figures are also available in the appendix. Apendix \ref{fig:results_close} shows the scene from a 
closer point of view, Appendix \ref{fig:results_far} shows the scene from a far point of view and lastly,
Appendix \ref{fig:results_anim} shows the animations of the caustics through pictures taken at several 
intervals of time.
...
% In addition, we have shown that implementing caustics and blur effects on watercolor images works 
% well and does not interfere with the watercolor effect.
...
\begin{figure}[h]
    ...
    \caption{Effect-less point of view.}
    \label{fig:no_blur}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Close up view of the depth blur.}
    \label{fig:blur}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{imgs/distant_blur.jpg}
    \caption{Depth blur as seen from a distant point.}
    \label{fig:distant_blur}
\end{figure}

\begin{figure*}[h]
	\centering
	\includegraphics[width=.55\linewidth]{imgs/results_close.png}
...
\begin{figure*}[h]
	\centering
	\includegraphics[width=.55\linewidth]{imgs/results_far.png}
...
\begin{figure*}[h]
	\centering
    \subfloat{\includegraphics[width=0.3\linewidth]{imgs/results_anim 0.png}\label{fig:results_anim0}}
    \hspace{1em}
    \subfloat{\includegraphics[width=0.3\linewidth]{imgs/results_anim 1.png}\label{fig:results_anim1}}
    \hspace{1em}
	\subfloat{\includegraphics[width=0.3\linewidth]{imgs/results_anim 2.png}\label{fig:results_anim2}}
